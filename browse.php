	     ...
	     function createSelector(layers) {
	      ...
	      function showModal() {
			  ...
			  $.ajax({
					...
					url: 'http://inventory.cartodb.com/api/v2/sql?q=SELECT * FROM ' + tableName + ' WHERE cartodb_id=' + lastFeature,
